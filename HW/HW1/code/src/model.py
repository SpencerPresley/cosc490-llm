...
def featurize(
    ...
    # Return None if no words were found in embedding vocabulary
    if not vectors:
        return None

    # Convert list of vectors to numpy array and take mean
...
class SentimentClassifier(nn.Module):
    def __init__(self, embed_dim, num_classes):
        ...
        # Create linear layer that projects from embed_dim to num_classes
...
def visualize_epochs(
    epoch_train_losses: List[float], epoch_dev_losses: List[float], 
    save_fig_path: str
):
    plt.clf()
